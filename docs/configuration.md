...
Its `test.instructions` block constrains the local Test step to scenario-driven, bounded foreground evidence rather than a family or full-suite walk; the file itself owns the exact wording, and broad regression stays with hosted CI.
