...
The guard does not consult session-lock ownership; [turnend-guard.md](turnend-guard.md#guard-predicates) states that a lock-refused second primary still receives the warning.
