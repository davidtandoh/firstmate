...
The shared session-lock owner also distinguishes an owning supervisor from a verified non-owning worker; [turnend-guard.md](turnend-guard.md#guard-predicates) owns that process-role boundary.
