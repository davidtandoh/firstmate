...
`tests/fm-session-lock-ancestry.test.sh` covers the Claude auto-arm's lock ownership over real process trees, plus structural identity surviving hidden arguments and unreadable identity proving neither foreign ownership nor process death.
